            ...
            <div className="products">
              <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-4">
                {search.map((product) => (
                  <div
                    key={product.id}
                    className="product relative duration-500 cursor-pointer flex flex-col justify-between rounded-lg"
                  >
                    ...
                    <div className="p-2 pt-0 flex justify-between items-center space-x-2">
                      {loading ? (
                        <button
                          type="button"
                        ...
                        <button
                          ...
                          className="bg-green-500 flex-1 p-2 rounded text-white btn"
                        >
                          Add to cart
                        </button>
                      )}
